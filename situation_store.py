"""琪露诺此刻的处境——她住在主人的电脑里，所以主人在哪，她就在哪。

这不是"关于主人的信息"，是她自己的处境：主人把电脑塞进包里，那是她被塞进包里。
...
class SituationStore:
    ...
    def build_prompt(self, master_name: str = "大妖精") -> str:
        if not self._alive():
            return ""
        parts = [
            f"\n【你此刻在哪】你住在{master_name}的电脑里，她走到哪你就跟到哪。"
            f"她刚跟你说了现在的情况（她说的「我」指她自己，「你」指你）：{self.text}",
            "\n这是你自己的处境，不是听来的消息——你就在现场。"
